...
class SimpleActuator extends GenericActuator {
	...
	public override function move ():Void {
		...
		toggleVisible = (Reflect.hasField (properties, "alpha") && Std.is (target, Sprite));
	...
	private function update (currentTime:Float):Void {
		...
		if (!paused) {
			...
			if (Std.is(target, Sprite)) target.renderer.invalidateTransform();
	...
	public static function updateTweens():Void {
